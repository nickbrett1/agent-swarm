...
import workerDefault, { ShopperAgent, verifyHmacSignature, getBrowserTimeLimit, handleInfo, getCorsOrigin, getCorsHeaders } from './index';
...
describe('CORS Helpers', () => {
  ...
  describe('getCorsHeaders', () => {
    it('returns standard CORS headers with correct allowed origin', () => {
      const request = new Request('https://example.com', { headers: { Origin: 'https://localhost:3000' } });
